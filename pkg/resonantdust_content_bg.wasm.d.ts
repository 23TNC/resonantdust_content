...
export const allPlayerBlueprints: () => [number, number, number];
...
export const playerBlueprintById: (a: number) => [number, number, number];
export const playerBlueprintByKey: (a: number, b: number) => [number, number, number];
